...
public class Fragment_OrtHesap extends Fragment implements OnClickListener,
	...
	public void btn_Hesapla_Click1() {
		...
		kutuphane.getAlertDialog(getActivity(), "Not Ortalamasý",
				" Dönemlik Not Ortalamanýz : " + String.valueOf(ortalamam)
	...
	public void btn_Hesapla_Diger_Click() {
		...
		kutuphane.getAlertDialog(getActivity(), "DEU Ýstatistik",
				"Not Ortalamanýz : " + String.valueOf(ortalamam));
	}
